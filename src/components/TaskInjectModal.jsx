            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div className="pt-4 flex justify-end gap-3 border-t border-slate-800">
                ...
                <button 
                  type="submit"
                  disabled={isSubmitting}
                  className={`flex items-center justify-center gap-2 px-5 py-2 min-w-[140px] bg-axim-teal-600 text-white rounded-lg text-sm font-semibold transition-colors ${isSubmitting ? 'opacity-50 cursor-not-allowed bg-axim-teal-800' : 'hover:bg-axim-teal-500'}`}
                >
                  {isSubmitting ? (
                    <>
