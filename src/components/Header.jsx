      ...
      <div className="flex items-center gap-4">
        ...
        {isCircuitBroken ? (
          <button
            ...
            className="flex items-center gap-2 px-4 py-1.5 bg-rose-600 hover:bg-rose-500 rounded-lg text-sm font-semibold text-white transition-colors shadow-lg shadow-rose-900/20"
          >
